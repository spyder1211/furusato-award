                        ...
                        @else
                            <form method="POST" action="{{ route('municipalities.offers.store') }}">
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea name="message" id="message" rows="4" class="w-full px-4 py-3 rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" placeholder="連携したい内容や理由を記載してください（最大1000文字）">{{ old('message') }}</textarea>
                                    @error('message')
