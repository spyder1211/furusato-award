                        ...
                        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                            <div class="p-6">
                                <div class="flex justify-between items-start mb-4">
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-600">
                                            @if($offer->receiver->municipalityProfile)
                                                {{ $offer->receiver->municipalityProfile->prefecture }}
                                                {{ $offer->receiver->municipalityProfile->city }}
                                            @endif
                                        </p>
                                    </div>
                                ...
                                <div class="flex justify-end">
                                    <a href="{{ route('municipalities.show', $offer->receiver->municipalityProfile->id) }}" class="inline-flex items-center px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 focus:bg-gray-700 active:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150">
                                        プロフィールを見る
                                    </a>
                                </div>
                            </div>
